// FutureDayView.js - View for future days
...
const FutureDayView = ({ 
  ...
  // Use helper functions to get activities and events by period
  console.log(`FutureDayView rendering for day ${dayIndex}, activities: ${activities.length}, events: ${events.length}`);
